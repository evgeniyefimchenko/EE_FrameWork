...
if ($logoUrl === '') {
    $logoUrl = '/assets/img/allbriz-logo.png';
}
...
?>
<footer class="allbriz-public-footer">
    <div class="container">
        <div class="allbriz-footer-grid">
            <div>
                <a class="allbriz-footer-brand" href="<?= htmlspecialchars((string) ENV_URL_SITE, ENT_QUOTES, 'UTF-8') ?>">
                    <img class="allbriz-brand-logo" src="<?= htmlspecialchars($logoUrl, ENT_QUOTES, 'UTF-8') ?>" alt="<?= htmlspecialchars((string) ENV_SITE_NAME, ENT_QUOTES, 'UTF-8') ?>">
                </a>
            </div>
            <div>
                <h3><?= htmlspecialchars((string) ($footerContent['sections_title'] ?? 'Разделы'), ENT_QUOTES, 'UTF-8') ?></h3>
                <div class="allbriz-footer-links">
        ...
        <div class="allbriz-footer-bottom">
