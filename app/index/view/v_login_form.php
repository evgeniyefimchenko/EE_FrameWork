            ...
            <div class="modal-content">
                        ...
                        <div class="content registerBox" style="display:none;">
                            <div class="form">
                                <form id="reg_form" method="post" accept-charset="UTF-8">
                                    ...
                                    <input class="btn btn-default btn-register" type="submit" value="<?=$lang['sys.sign_in']?>" name="commit">
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <div class="forgot login-footer">
                        <span>
                            <a href="javascript: showRegisterForm();"><?=$lang['sys.sign_in']?></a><br/>
                            <a href="javascript: showRecoveryForm();"><?=$lang['sys.restore_password']?></a>
                        </span>
                    </div>
                    <div class="forgot register-footer" style="display:none;">
                        <a href="javascript: showLoginForm();"><?=$lang['sys.log_in']?></a>
                        <br/>
                        <a href="javascript: showRecoveryForm();"><?=$lang['sys.restore_password']?></a>
                    </div>
                    <div class="forgot recovery-footer" style="display:none;">
                        <a href="javascript: showRegisterForm();"><?=$lang['sys.sign_in']?></a>
                        <br/>
                        <a href="javascript: showLoginForm();"><?=$lang['sys.log_in']?></a>
                    </div>
                </div>        
