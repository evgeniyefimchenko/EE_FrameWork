			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="card mt-3 pl-3 w-25">
						...
						<a href="//efimchenko.ru" target="_BLANK">Мой сайт - <span class="float-end badge bg-secondary">efimchenko.ru</span></a>
						...
						<a href="https://vk.com/id113807047" target="_BLANK">Вконтакте - <span class="float-end badge bg-secondary">https://vk.com/id113807047</span></a>
					</div>
				</div>
			</div>
		</div>
