...
<main>
    <div class="container-fluid px-4">
        ...
        ?>
        <a href="/admin/page_edit/id?language_code=<?= rawurlencode((string) $currentUiLanguageCode) ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="<?= $lang['sys.add'] ?>" type="button"
