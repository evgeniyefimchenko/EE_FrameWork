...
$C['ENV_SITE_NAME'] = 'Новейший сайт';
$C['ENV_SITE_AUTHOR'] = 'Автор сайта';
$C['ENV_DATE_SITE_CREATE'] = '01.09.2018';
$C['ENV_DIRSEP'] = DIRECTORY_SEPARATOR;  // Разделитель операционной системы
$C['ENV_DOMEN_PROTOCOL'] = stripos($_SERVER['SERVER_PROTOCOL'], 'https') === true ? 'https://' : 'http://'; // Протокол сайта
...
$C['ENV_SECRET_KEY'] = '<{"u*{y$Pv.x@p{'; // Ключ защиты форм сайта
$C['ENV_SITE'] = 1;					     // Логическая константа
$C['ENV_TEST'] = 0;      				// Режим работы сайта 1 - тест 0 - рабочий
$C['ENV_TIME_SESSION'] = 86400;    // Срок жизни сессии (86400 - сутки)   // Имя сайта
