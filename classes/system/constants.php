...
class Constants {
    ...
    public const USERS_TABLE = ENV_DB_PREF . 'users',
            ...
            CATEGORIES_TABLE_FIELDS = ['category_id','type_id','title','slug','route_path','description','short_description','parent_id','status','search_enabled','search_scope_mask','created_at','updated_at','language_code'],
            ...
            PAGES_TABLE_FIELDS = ['page_id','parent_page_id','category_id','status','sort_order','title','slug','route_path','short_description','description','search_enabled','search_scope_mask','created_at','updated_at','language_code'],
            ENTITY_TRANSLATIONS_TABLE = ENV_DB_PREF . 'entity_translations',
            ENTITY_TRANSLATIONS_TABLE_FIELDS = [],
            URL_POLICIES_TABLE = ENV_DB_PREF . 'url_policies',
            URL_POLICIES_TABLE_FIELDS = [],
            ENTITY_LEGACY_PATHS_TABLE = ENV_DB_PREF . 'entity_legacy_paths',
            ENTITY_LEGACY_PATHS_TABLE_FIELDS = [],
            REDIRECTS_TABLE = ENV_DB_PREF . 'redirects',
            REDIRECTS_TABLE_FIELDS = [],
            PAGE_USER_LINKS_TABLE = ENV_DB_PREF . 'page_user_links',
            PAGE_USER_LINKS_TABLE_FIELDS = [],
            ...
            PROPERTIES_TABLE_FIELDS = ['property_id','type_id','name','status','sort','default_values','schema_version','is_multiple','is_required','search_enabled_default','description','entity_type','created_at','updated_at','language_code'],
            ...
            SEARCH_INDEX_TABLE_FIELDS = ['search_id','entity_id','entity_type','language_code','title','content_full','url','search_scope_mask','static_rank','popularity_score','last_updated'],
