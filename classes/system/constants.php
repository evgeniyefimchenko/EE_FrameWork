...
class Constants {
    ...
    public const USERS_TABLE = ENV_DB_PREF . 'users',
            ...
            PAGES_TABLE_FIELDS = ['page_id','parent_page_id','category_id','status','title','slug','route_path','short_description','description','search_enabled','search_scope_mask','created_at','updated_at','language_code'],
