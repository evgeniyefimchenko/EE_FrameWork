...
Class Router {
    ...
    private function getController(&$file, &$controller, &$action, &$args) {
        ...
        if (ENV_TEST) {
            print_r(array('file' => $file, 'controller' => 'Controller_' . $controller, 'action' => $action, 'args' => $args));
        }
    }
